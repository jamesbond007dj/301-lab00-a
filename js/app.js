...
function displayPics(){
  ...
  // We needed to console.log(rando) inside the function because var was global variable and it could use out of the function.
  // when we changed the var to const, the variable was not global any more and could be use only inside of the function.
  console.log(viewed);
